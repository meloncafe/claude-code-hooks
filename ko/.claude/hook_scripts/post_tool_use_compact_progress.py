...
백그라운드로 실행 중인 auto_compact.py의 진행 상황을 표시합니다.
"""
...
def display_progress(status: Dict[str, Any]) -> None:
    ...
    if status_type == 'running':
        ...
        sys.stderr.write(f"\r🔄 컨텍스트 압축 진행 중... [{progress_bar}] {progress}% - {message}")
        sys.stderr.flush()
        ...
        msg += "✅ 컨텍스트 압축 완료\n"
        msg += "="*70 + "\n"
        msg += "다음 세션을 시작하면 압축된 요약을 볼 수 있습니다.\n"
        msg += "현재 세션을 종료하려면 /clear 또는 새 세션을 시작하세요.\n"
        msg += "="*70 + "\n\n"
        ...
        msg += "="*70 + "\n"
        msg += f"오류: {error}\n"
        msg += "로그를 확인하세요: .claude/logs/hooks/auto-compact.log\n"
        msg += "="*70 + "\n\n"
