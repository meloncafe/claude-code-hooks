...
Hook 스크립트에서 사용할 공통 Rich 컴포넌트 및 스타일 정의
"""
...
# 공통 Console 인스턴스 (width=140으로 긴 텍스트 줄바꿈 방지)
...
def print_code_example(
    ...
    """코드 예시를 Syntax Highlighting과 함께 출력"""
